...
(function($) {
	...
	function _4a(_4b, _4c) {
		...
		var _51 = $("<div class=\"datagrid-wrap\">"
	...
	function _72(_73) {
		...
		_78.unbind(".datagrid").bind("click.datagrid", function(e) {
			...
			var p1 = $(this).offset().left + 5;
			var p2 = $(this).offset().left + $(this)._outerWidth() - 5;
			var _7a = _76.resizeHandle == "right"
					? (e.pageX > p2)
					: (_76.resizeHandle == "left"
							? (e.pageX < p1)
		...
		var _7c = _76.resizeHandle == "right"
				? "e"
		...
		_78.each(function() {
			$(this).resizable({
				...
				onStartResize : function(e) {
					...
					if (!_74.proxy) {
						_74.proxy = $("<div class=\"datagrid-resize-proxy\"></div>")
								.appendTo(dc.view);
					}
					_74.proxy.css({
		...
		function _1c(_ad) {
			...
			function _b0(_b1) {
				...
				if (_b1 == "header") {
					...
					_aa.finder.getTr(_a7, 0, _b1).find("td[field=\"" + _ad
				...
				return _b2;
				function _b3(_b4) {
					return _b4.is(":visible") ? _b4._outerWidth() : tmp
							.html(_b4.html())._outerWidth();
				};
			};
		};
	};
	...
	function _fb(_fc, _fd) {
		...
		var _ff = _fe.options;
		_ff.finder.getTr(_fc, _fe.highlightIndex)
	...
	function _106(_116, _117) {
		...
		opts.finder.getTr(_116, "", "selected")
	...
	function _114(_126, _127) {
		...
		var bck = opts.finder.getTr(_126, "", "allbody")
	...
	function _11a(_129, _12a) {
		...
		var dc = _12b.dc;
		var hck = dc.header1.add(dc.header2).find("input[type=checkbox]");
		var bck = opts.finder.getTr(_129, "", "checked")
				.removeClass("datagrid-row-checked")
				.find("div.datagrid-cell-check input[type=checkbox]");
	...
	function _17e(_17f, _180) {
		...
		var tr = opts.finder.getTr(_17f, (_180.index != undefined
						? _180.index
						: _180.id));
		if (!tr.length) {
			return;
	...
	var _186 = {
		text : {
			init : function(_187, _188) {
				var _189 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_187);
				return _189;
			},
		...
		textarea : {
			init : function(_18f, _190) {
				var _191 = $("<textarea class=\"datagrid-editable-input\"></textarea>")
						.appendTo(_18f);
				return _191;
			},
		...
		numberbox : {
			init : function(_19e, _19f) {
				var _1a0 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_19e);
				_1a0.numberbox(_19f);
				return _1a0;
			},
		...
		validatebox : {
			init : function(_1a7, _1a8) {
				var _1a9 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_1a7);
	...
	$.fn.datagrid.parseOptions = function(_201) {
		...
		return $.extend({}, $.fn.panel.parseOptions(_201), $.parser
						.parseOptions(_201, ["url", "toolbar", "idField",
										"sortName", "sortOrder",
	...
	$.fn.datagrid.parseData = function(_202) {
		...
		var _203 = t.datagrid("getColumnFields", true).concat(t.datagrid(
	...
	var _204 = {
		...
		onAfterRender : function(_23d) {
			...
			if (opts.showFooter) {
				var _23e = $(_23d).datagrid("getPanel")
		...
		finder : {
			getTr : function(_244, _245, type, _246) {
				...
				if (_246 == 0) {
					...
					if (type == "body") {
						var tr = $("#" + _247.rowIdPrefix + "-" + _246 + "-"
								+ _245);
						if (!tr.length) {
							tr = (_246 == 1 ? dc.body1 : dc.body2)
						...
						if (type == "footer") {
							return (_246 == 1 ? dc.footer1 : dc.footer2)
									.find(">table>tbody>tr[datagrid-row-index="
											+ _245 + "]");
						} else {
							if (type == "selected") {
								return (_246 == 1 ? dc.body1 : dc.body2)
